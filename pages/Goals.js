  ...
  return (
    <div className=" about ">
      <Navbar/>
        ...
        <div className=" w-48 md:w-72 mt-10  m-auto md:m-0 md:grid">
      <Image src={img} />
      </div>
        <h2  className=" text-3xl md:text-5xl text-center  md:mt-28 text-white">Milestone Goals</h2>
      ...
      <div className="  md:p-14 contetnt bg-lime-50 md:pb-32 mb-9">
        ...
        <div className="md:w-10/12 m-auto     ">
          ...
          <div className="md:mt-10 p-5 prgm__row">
